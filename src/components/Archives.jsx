...
const Archives = () => {
  ...
  const handleFiltersChange = (category, label, selected) => {
    setFilters((prevFilters) => {
      const updatedCategoryFilters = selected
        ? [...prevFilters[category], label]
        : prevFilters[category].filter((item) => item !== label);
  ...
  return (
    <div className="flex items-center gap-10 ">
      <div className="flex flex-col gap-10 justify-center items-center px-5  py-6">
        <div className="bg-secondary px-4 py-2 w-full lg:w-[80%] rounded-md poppins-light flex flex-col md:flex-row items-center gap-2">
